...
app = FastAPI(title="채소팜 통합 처리기", version="1.1.0")
...
async def upload_files(
    ...
    if order_attached:
        message = "업로드가 접수되었습니다. 시트 반영 후 주문대조/가격계산을 진행하고 텔레그램으로 결과를 보냅니다."
        mode = "full"
    else:
        message = "업로드가 접수되었습니다. 거래명세서 기준으로 날짜 시트를 반영합니다. 주문내역이 없어서 주문대조/가격/텔레그램 전송은 건너뜁니다."
        mode = "sheet_only"
